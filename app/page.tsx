        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-blue-50/80 backdrop-blur-sm rounded-full px-6 py-2 mb-8 border border-blue-200">
              ...
              <span className="text-sm text-blue-700 font-medium">Built for Tata Innovent 2026</span>
            </div>
            ...
            <p className="text-xl text-slate-600 mb-12 leading-relaxed max-w-3xl mx-auto">
              ...
              and professional service management designed for modern automotive excellence.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button 
                size="lg" 
                onClick={() => router.push('/auth/signup')}
                className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-4 text-lg shadow-xl font-medium transform hover:scale-105 transition-all duration-200"
              >
              ...
              <Button 
                ...
                variant="outline" 
                onClick={() => router.push('/auth/signup')}
                className="border-slate-300 text-slate-700 hover:bg-slate-50 backdrop-blur-sm px-8 py-4 text-lg font-medium"
              >
            ...
            {features.map((feature, index) => (
              <Card key={index} className="bg-white/80 backdrop-blur-md border-slate-200 hover:bg-white/90 transition-all duration-300 group overflow-hidden shadow-lg">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-2xl text-slate-800 group-hover:text-blue-700 transition-colors">
                    {feature.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            {[
              ...
              <div key={index} className="text-center group">
                <div className="relative mb-8">
                  <div className="w-24 h-24 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl flex items-center justify-center text-white mx-auto shadow-xl group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white text-sm font-bold">
                    {item.step}
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-md rounded-3xl p-16 border border-slate-200 shadow-xl">
            ...
            <Button 
              size="lg" 
              onClick={() => router.push('/auth/signup')}
              className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-12 py-6 text-xl shadow-xl font-medium transform hover:scale-105 transition-all duration-200"
            >
      ...
      <footer className="relative z-10 bg-white/80 backdrop-blur-md border-t border-slate-200 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-600 mb-4">
            Built for Tata Innovent 2026 - Professional automotive intelligence platform
          </p>
